...
[ 0x09 ; x09 ;      ; add16 (IX, BC)    ; 11 ; doc   ; z80   ]
...
[ 0x19 ; x19 ;      ; add16 (IX, DE)    ; 11 ; doc   ; z80   ]
...
[ 0x21 ; x21 ; nn   ; ld16  (IX, nn)    ; 10 ; doc   ; z80   ]
[ 0x22 ; x22 ; nn   ; ld16  ((nn), IX)  ; 16 ; doc   ; z80   ]
[ 0x23 ; x23 ;      ; inc16 (IX)        ;  6 ; doc   ; z80   ]
[ 0x24 ; x24 ;      ; inc   (IXH)       ;  4 ; undoc ; z80   ]
[ 0x25 ; x25 ;      ; dec   (IXH)       ;  4 ; undoc ; z80   ]
[ 0x26 ; x26 ; n    ; ld    (IXH, n)    ;  7 ; undoc ; z80   ]

[ 0x27 ; x27 ;    ; daa    ()         ;  4 ; undoc ; z80   ]
[ 0x28 ; x28 ; e  ; jrcc   (Zcc, e)   ; xx ; undoc ; z80   ]

[ 0x29 ; x29 ;      ; add16 (IX, IX)    ; 11 ; doc   ; z80   ]
[ 0x2A ; x2A ; nn   ; ld16  (IX, (nn))  ; 16 ; doc   ; z80   ]
[ 0x2B ; x2B ;      ; dec16 (IX)        ;  6 ; doc   ; z80   ]
[ 0x2C ; x2C ;      ; inc   (IXL)       ;  4 ; undoc ; z80   ]
[ 0x2D ; x2D ;      ; dec   (IXL)       ;  4 ; undoc ; z80   ]
[ 0x2E ; x2E ; n    ; ld    (IXL, n)    ;  7 ; undoc ; z80   ]
...
[ 0x34 ; x34 ; d    ; inc   ((IX+d))    ; 19 ; doc   ; z80   ]
[ 0x35 ; x35 ; d    ; dec   ((IX+d))    ; 19 ; doc   ; z80   ]
[ 0x36 ; x36 ; d, n ; ld    ((IX+d), n) ; 15 ; doc   ; z80   ]

[ 0x37 ; x37 ;    ; scf    ()         ;  4 ; undoc ; z80   ]
[ 0x38 ; x38 ; e  ; jrcc   (Ccc, e)   ; xx ; undoc ; z80   ]

[ 0x39 ; x39 ;      ; add16 (IX, SP)    ; 11 ; doc   ; z80   ]
...
[ 0x44 ; x44 ;      ; ld    (B, IXH)    ;  4 ; undoc ; z80   ]
[ 0x45 ; x45 ;      ; ld    (B, IXL)    ;  4 ; undoc ; z80   ]
[ 0x46 ; x46 ; d    ; ld    (B, (IX+d)) ; 15 ; doc   ; z80   ]
...
[ 0x4C ; x4C ;      ; ld    (C, IXH)    ;  4 ; undoc ; z80   ]
[ 0x4D ; x4D ;      ; ld    (C, IXL)    ;  4 ; undoc ; z80   ]
[ 0x4E ; x4E ; d    ; ld    (C, (IX+d)) ; 15 ; doc   ; z80   ]
...
[ 0x54 ; x54 ;      ; ld    (D, IXH)    ;  4 ; undoc ; z80   ]
[ 0x55 ; x55 ;      ; ld    (D, IXL)    ;  4 ; undoc ; z80   ]
[ 0x56 ; x56 ; d    ; ld    (D, (IX+d)) ; 15 ; doc   ; z80   ]
...
[ 0x5C ; x5C ;      ; ld    (E, IXH)    ;  4 ; undoc ; z80   ]
[ 0x5D ; x5D ;      ; ld    (E, IXL)    ;  4 ; undoc ; z80   ]
[ 0x5E ; x5E ; d    ; ld    (E, (IX+d)) ; 15 ; doc   ; z80   ]

[ 0x5F ; x5F ;    ; ld     (E, A)     ;  4 ; undoc ; z80   ]

[ 0x60 ; x60 ;      ; ld    (IXH, B)    ;  4 ; undoc ; z80   ]
[ 0x61 ; x61 ;      ; ld    (IXH, C)    ;  4 ; undoc ; z80   ]
[ 0x62 ; x62 ;      ; ld    (IXH, D)    ;  4 ; undoc ; z80   ]
[ 0x63 ; x63 ;      ; ld    (IXH, E)    ;  4 ; undoc ; z80   ]
[ 0x64 ; x64 ;      ; ld    (IXH, IXH)  ;  4 ; undoc ; z80   ]
[ 0x65 ; x65 ;      ; ld    (IXH, IXL)  ;  4 ; undoc ; z80   ]
[ 0x66 ; x66 ; d    ; ld    (H, (IX+d)) ; 15 ; doc   ; z80   ]
[ 0x67 ; x67 ;      ; ld    (IXH, A)    ;  4 ; undoc ; z80   ]
[ 0x68 ; x68 ;      ; ld    (IXL, B)    ;  4 ; undoc ; z80   ]
[ 0x69 ; x69 ;      ; ld    (IXL, C)    ;  4 ; undoc ; z80   ]
[ 0x6A ; x6A ;      ; ld    (IXL, D)    ;  4 ; undoc ; z80   ]
[ 0x6B ; x6B ;      ; ld    (IXL, E)    ;  4 ; undoc ; z80   ]
[ 0x6C ; x6C ;      ; ld    (IXL, IXH)  ;  4 ; undoc ; z80   ]
[ 0x6D ; x6D ;      ; ld    (IXL, IXL)  ;  4 ; undoc ; z80   ]
[ 0x6E ; x6E ; d    ; ld    (L, (IX+d)) ; 15 ; doc   ; z80   ]
[ 0x6F ; x6F ;      ; ld    (IXL, A)    ;  4 ; undoc ; z80   ]
[ 0x70 ; x70 ; d    ; ld    ((IX+d), B) ; 15 ; doc   ; z80   ]
[ 0x71 ; x71 ; d    ; ld    ((IX+d), C) ; 15 ; doc   ; z80   ]
[ 0x72 ; x72 ; d    ; ld    ((IX+d), D) ; 15 ; doc   ; z80   ]
[ 0x73 ; x73 ; d    ; ld    ((IX+d), E) ; 15 ; doc   ; z80   ]
[ 0x74 ; x74 ; d    ; ld    ((IX+d), H) ; 15 ; doc   ; z80   ]
[ 0x75 ; x75 ; d    ; ld    ((IX+d), L) ; 15 ; doc   ; z80   ]

[ 0x76 ; x76 ;    ; halt   ()         ;  4 ; undoc ; z80   ]

[ 0x77 ; x77 ; d    ; ld    ((IX+d), A) ; 15 ; doc   ; z80   ]
...
[ 0x7C ; x7C ;      ; ld    (A, IXH)    ;  4 ; undoc ; z80   ]
[ 0x7D ; x7D ;      ; ld    (A, IXL)    ;  4 ; undoc ; z80   ]
[ 0x7E ; x7E ; d    ; ld    (A, (IX+d)) ; 15 ; doc   ; z80   ]
...
[ 0x84 ; x84 ;      ; add   (A, IXH)    ;  4 ; undoc ; z80   ]
[ 0x85 ; x85 ;      ; add   (A, IXL)    ;  4 ; undoc ; z80   ]
[ 0x86 ; x86 ; d    ; add   (A, (IX+d)) ; 15 ; doc   ; z80   ]
...
[ 0x8C ; x8C ;      ; adc   (A, IXH)    ;  4 ; undoc ; z80   ]
[ 0x8D ; x8D ;      ; adc   (A, IXL)    ;  4 ; undoc ; z80   ]
[ 0x8E ; x8E ; d    ; adc   (A, (IX+d)) ; 15 ; doc   ; z80   ]
...
[ 0x94 ; x94 ;      ; sub   (A, IXH)    ;  4 ; undoc ; z80   ]
[ 0x95 ; x95 ;      ; sub   (A, IXL)    ;  4 ; undoc ; z80   ]
[ 0x96 ; x96 ; d    ; sub   (A, (IX+d)) ; 15 ; doc   ; z80   ]
...
[ 0x9C ; x9C ;      ; sbc   (A, IXH)    ;  4 ; undoc ; z80   ]
[ 0x9D ; x9D ;      ; sbc   (A, IXL)    ;  4 ; undoc ; z80   ]
[ 0x9E ; x9E ; d    ; sbc   (A, (IX+d)) ; 15 ; doc   ; z80   ]
...
[ 0xA4 ; xA4 ;      ; and   (IXH)       ;  4 ; undoc ; z80   ]
[ 0xA5 ; xA5 ;      ; and   (IXL)       ;  4 ; undoc ; z80   ]
[ 0xA6 ; xA6 ; d    ; and   ((IX+d))    ; 15 ; doc   ; z80   ]
...
[ 0xAC ; xAC ;      ; xor   (IXH)       ;  4 ; undoc ; z80   ]
[ 0xAD ; xAD ;      ; xor   (IXL)       ;  4 ; undoc ; z80   ]
[ 0xAE ; xAE ; d    ; xor   ((IX+d))    ; 15 ; doc   ; z80   ]
...
[ 0xB4 ; xB4 ;      ; or    (IXH)       ;  4 ; undoc ; z80   ]
[ 0xB5 ; xB5 ;      ; or    (IXL)       ;  4 ; undoc ; z80   ]
[ 0xB6 ; xB6 ; d    ; or    ((IX+d))    ; 15 ; doc   ; z80   ]
...
[ 0xBC ; xBC ;      ; cp    (IXH)       ;  4 ; undoc ; z80   ]
[ 0xBD ; xBD ;      ; cp    (IXL)       ;  4 ; undoc ; z80   ]
[ 0xBE ; xBE ; d    ; cp    ((IX+d))    ; 15 ; doc   ; z80   ]
