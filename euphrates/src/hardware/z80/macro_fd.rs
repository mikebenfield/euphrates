macro_rules! euphrates_z80_fd {
    ($mac: ident) => {
        euphrates_z80_fd! {@ $mac
(
...
[ 0x09 ; x09 ;      ; add16 (IY, BC)    ; 11 ; doc   ; z80 ; no  ]
...
[ 0x19 ; x19 ;      ; add16 (IY, DE)    ; 11 ; doc   ; z80 ; no  ]
...
[ 0x21 ; x21 ; nn   ; ld16  (IY, nn)    ; 10 ; doc   ; z80 ; mem  ]
[ 0x22 ; x22 ; nn   ; ld16  ((nn), IY)  ; 16 ; doc   ; z80 ; mem  ]
[ 0x23 ; x23 ;      ; inc16 (IY)        ;  6 ; doc   ; z80 ; no   ]
[ 0x24 ; x24 ;      ; inc   (IYH)       ;  4 ; undoc ; z80 ; mem  ]
[ 0x25 ; x25 ;      ; dec   (IYH)       ;  4 ; undoc ; z80 ; mem  ]
[ 0x26 ; x26 ; n    ; ld    (IYH, n)    ;  7 ; undoc ; z80 ; mem  ]

[ 0x27 ; x27 ;    ; daa    ()         ;  4 ; undoc ; z80 ; no  ]
[ 0x28 ; x28 ; e  ; jrcc   (Zcc, e)   ; xx ; undoc ; z80 ; no  ]

[ 0x29 ; x29 ;      ; add16 (IY, IY)    ; 11 ; doc   ; z80 ; no  ]
[ 0x2A ; x2A ; nn   ; ld16  (IY, (nn))  ; 16 ; doc   ; z80 ; mem ]
[ 0x2B ; x2B ;      ; dec16 (IY)        ;  6 ; doc   ; z80 ; no  ]
[ 0x2C ; x2C ;      ; inc   (IYL)       ;  4 ; undoc ; z80 ; mem ]
[ 0x2D ; x2D ;      ; dec   (IYL)       ;  4 ; undoc ; z80 ; mem ]
[ 0x2E ; x2E ; n    ; ld    (IYL, n)    ;  7 ; undoc ; z80 ; mem ]
...
[ 0x34 ; x34 ; d    ; inc   ((IY+d))    ; 19 ; doc   ; z80 ; mem   ]
[ 0x35 ; x35 ; d    ; dec   ((IY+d))    ; 19 ; doc   ; z80 ; mem   ]
[ 0x36 ; x36 ; d, n ; ld    ((IY+d), n) ; 15 ; doc   ; z80 ; mem   ]

[ 0x37 ; x37 ;    ; scf    ()         ;  4 ; undoc ; z80 ; no    ]
[ 0x38 ; x38 ; e  ; jrcc   (Ccc, e)   ; xx ; undoc ; z80 ; no    ]

[ 0x39 ; x39 ;      ; add16 (IY, SP)    ; 11 ; doc   ; z80 ; no   ]
...
[ 0x44 ; x44 ;      ; ld    (B, IYH)    ;  4 ; undoc ; z80 ; mem   ]
[ 0x45 ; x45 ;      ; ld    (B, IYL)    ;  4 ; undoc ; z80 ; mem   ]
[ 0x46 ; x46 ; d    ; ld    (B, (IY+d)) ; 15 ; doc   ; z80 ; mem   ]
...
[ 0x4C ; x4C ;      ; ld    (C, IYH)    ;  4 ; undoc ; z80 ; mem   ]
[ 0x4D ; x4D ;      ; ld    (C, IYL)    ;  4 ; undoc ; z80 ; mem   ]
[ 0x4E ; x4E ; d    ; ld    (C, (IY+d)) ; 15 ; doc   ; z80 ; mem   ]
...
[ 0x54 ; x54 ;      ; ld    (D, IYH)    ;  4 ; undoc ; z80 ; mem   ]
[ 0x55 ; x55 ;      ; ld    (D, IYL)    ;  4 ; undoc ; z80 ; mem   ]
[ 0x56 ; x56 ; d    ; ld    (D, (IY+d)) ; 15 ; doc   ; z80 ; mem   ]
...
[ 0x5C ; x5C ;      ; ld    (E, IYH)    ;  4 ; undoc ; z80 ; mem   ]
[ 0x5D ; x5D ;      ; ld    (E, IYL)    ;  4 ; undoc ; z80 ; mem   ]
[ 0x5E ; x5E ; d    ; ld    (E, (IY+d)) ; 15 ; doc   ; z80 ; mem   ]

[ 0x5F ; x5F ;    ; ld     (E, A)     ;  4 ; undoc ; z80 ; mem   ]

[ 0x60 ; x60 ;      ; ld    (IYH, B)    ;  4 ; undoc ; z80 ; mem   ]
[ 0x61 ; x61 ;      ; ld    (IYH, C)    ;  4 ; undoc ; z80 ; mem   ]
[ 0x62 ; x62 ;      ; ld    (IYH, D)    ;  4 ; undoc ; z80 ; mem   ]
[ 0x63 ; x63 ;      ; ld    (IYH, E)    ;  4 ; undoc ; z80 ; mem   ]
[ 0x64 ; x64 ;      ; ld    (IYH, IYH)  ;  4 ; undoc ; z80 ; mem   ]
[ 0x65 ; x65 ;      ; ld    (IYH, IYL)  ;  4 ; undoc ; z80 ; mem   ]
[ 0x66 ; x66 ; d    ; ld    (H, (IY+d)) ; 15 ; doc   ; z80 ; mem   ]
[ 0x67 ; x67 ;      ; ld    (IYH, A)    ;  4 ; undoc ; z80 ; mem   ]
[ 0x68 ; x68 ;      ; ld    (IYL, B)    ;  4 ; undoc ; z80 ; mem   ]
[ 0x69 ; x69 ;      ; ld    (IYL, C)    ;  4 ; undoc ; z80 ; mem   ]
[ 0x6A ; x6A ;      ; ld    (IYL, D)    ;  4 ; undoc ; z80 ; mem   ]
[ 0x6B ; x6B ;      ; ld    (IYL, E)    ;  4 ; undoc ; z80 ; mem   ]
[ 0x6C ; x6C ;      ; ld    (IYL, IYH)  ;  4 ; undoc ; z80 ; mem   ]
[ 0x6D ; x6D ;      ; ld    (IYL, IYL)  ;  4 ; undoc ; z80 ; mem   ]
[ 0x6E ; x6E ; d    ; ld    (L, (IY+d)) ; 15 ; doc   ; z80 ; mem   ]
[ 0x6F ; x6F ;      ; ld    (IYL, A)    ;  4 ; undoc ; z80 ; mem   ]
[ 0x70 ; x70 ; d    ; ld    ((IY+d), B) ; 15 ; doc   ; z80 ; mem   ]
[ 0x71 ; x71 ; d    ; ld    ((IY+d), C) ; 15 ; doc   ; z80 ; mem   ]
[ 0x72 ; x72 ; d    ; ld    ((IY+d), D) ; 15 ; doc   ; z80 ; mem   ]
[ 0x73 ; x73 ; d    ; ld    ((IY+d), E) ; 15 ; doc   ; z80 ; mem   ]
[ 0x74 ; x74 ; d    ; ld    ((IY+d), H) ; 15 ; doc   ; z80 ; mem   ]
[ 0x75 ; x75 ; d    ; ld    ((IY+d), L) ; 15 ; doc   ; z80 ; mem   ]

[ 0x76 ; x76 ;    ; halt   ()         ;  4 ; undoc ; z80 ; no   ]

[ 0x77 ; x77 ; d    ; ld    ((IY+d), A) ; 15 ; doc   ; z80 ; mem   ]
...
[ 0x7C ; x7C ;      ; ld    (A, IYH)    ;  4 ; undoc ; z80 ; mem   ]
[ 0x7D ; x7D ;      ; ld    (A, IYL)    ;  4 ; undoc ; z80 ; mem   ]
[ 0x7E ; x7E ; d    ; ld    (A, (IY+d)) ; 15 ; doc   ; z80 ; mem   ]
...
[ 0x84 ; x84 ;      ; add   (A, IYH)    ;  4 ; undoc ; z80 ; mem   ]
[ 0x85 ; x85 ;      ; add   (A, IYL)    ;  4 ; undoc ; z80 ; mem   ]
[ 0x86 ; x86 ; d    ; add   (A, (IY+d)) ; 15 ; doc   ; z80 ; mem   ]
...
[ 0x8C ; x8C ;      ; adc   (A, IYH)    ;  4 ; undoc ; z80 ; mem   ]
[ 0x8D ; x8D ;      ; adc   (A, IYL)    ;  4 ; undoc ; z80 ; mem   ]
[ 0x8E ; x8E ; d    ; adc   (A, (IY+d)) ; 15 ; doc   ; z80 ; mem   ]
...
[ 0x94 ; x94 ;      ; sub   (A, IYH)    ;  4 ; undoc ; z80 ; mem   ]
[ 0x95 ; x95 ;      ; sub   (A, IYL)    ;  4 ; undoc ; z80 ; mem   ]
[ 0x96 ; x96 ; d    ; sub   (A, (IY+d)) ; 15 ; doc   ; z80 ; mem   ]
...
[ 0x9C ; x9C ;      ; sbc   (A, IYH)    ;  4 ; undoc ; z80 ; mem   ]
[ 0x9D ; x9D ;      ; sbc   (A, IYL)    ;  4 ; undoc ; z80 ; mem   ]
[ 0x9E ; x9E ; d    ; sbc   (A, (IY+d)) ; 15 ; doc   ; z80 ; mem   ]
...
[ 0xA4 ; xA4 ;      ; and   (IYH)       ;  4 ; undoc ; z80 ; mem   ]
[ 0xA5 ; xA5 ;      ; and   (IYL)       ;  4 ; undoc ; z80 ; mem   ]
[ 0xA6 ; xA6 ; d    ; and   ((IY+d))    ; 15 ; doc   ; z80 ; mem   ]
...
[ 0xAC ; xAC ;      ; xor   (IYH)       ;  4 ; undoc ; z80 ; mem   ]
[ 0xAD ; xAD ;      ; xor   (IYL)       ;  4 ; undoc ; z80 ; mem   ]
[ 0xAE ; xAE ; d    ; xor   ((IY+d))    ; 15 ; doc   ; z80 ; mem   ]
...
[ 0xB4 ; xB4 ;      ; or    (IYH)       ;  4 ; undoc ; z80 ; mem   ]
[ 0xB5 ; xB5 ;      ; or    (IYL)       ;  4 ; undoc ; z80 ; mem   ]
[ 0xB6 ; xB6 ; d    ; or    ((IY+d))    ; 15 ; doc   ; z80 ; mem   ]
...
[ 0xBC ; xBC ;      ; cp    (IYH)       ;  4 ; undoc ; z80 ; mem   ]
[ 0xBD ; xBD ;      ; cp    (IYL)       ;  4 ; undoc ; z80 ; mem   ]
[ 0xBE ; xBE ; d    ; cp    ((IY+d))    ; 15 ; doc   ; z80 ; mem   ]
...
[ 0xF9 ; xF9 ;      ; ld16  (SP, IY)    ;  6 ; doc   ; z80 ; mem   ]
